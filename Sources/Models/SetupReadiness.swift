...
struct SetupReadiness {
    enum Blocker: Equatable {
        ...
        var message: String {
            ...
            case .microphoneDenied: return "麦克风权限未开启，无法录音。请在“隐私与安全性 → 麦克风”中允许 Saylane。"
            case .inputMethodNotEnabled: return "输入法尚未启用，请先完成系统输入法添加。"
            case .inputMethodNotSelected: return "当前没有选中 Saylane。若已允许输入监控，按住说话会自动切过来；否则请先手动切到 Saylane。"
