...
已发布版本 `0.2.68`。语音识别和翻译默认走 Apple 端侧框架；可选的终稿润色才走外部 API。
...
从 [GitHub Release 下载 v0.2.68 安装包](https://github.com/LiuTianjie/Saylane/releases/tag/v0.2.68)，或访问 [产品网页](https://liutianjie.github.io/Saylane/)。Release 同时提供 SHA-256 校验文件。
